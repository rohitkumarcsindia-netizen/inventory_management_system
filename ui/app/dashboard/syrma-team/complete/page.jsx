...
const normalizeFinanceRecord = (rec) => {
  ...
  return {
    ...
    syrmaAction: rec.syrmaAction || o.syrmaAction,
    actionTime: rec.actionTime || o.actionTime,
    syrmaComments: rec.syrmaComments || o.syrmaComments,
    actionDoneBy: rec.actionDoneBy || o.actionDoneBy,
    updatedBy: rec.updatedBy || o.updatedBy
  };
};

export default function SyrmaCompleteOrders() {
