...
const normalizeFinanceRecord = (rec) => {
  ...
  let approved = rec.rmaApprovedBy || o.rmaApprovedBy;
  ...
  return {
    ...
    rmaAction: rec.rmaAction || o.rmaAction,
    rmaActionTime: rec.rmaActionTime || rec.rmaActionTime || o.rmaActionTime,
    rmaComment: rec.rmaComment || o.rmaComment,
    rmaApprovedByUserId: approvedUserId,
    rmaApprovedBy: rec.rmaApprovedBy || o.rmaApprovedBy

  };
};

export default function RmaCompleteOrders() {
