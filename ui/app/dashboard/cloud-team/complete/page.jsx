...
import CloudCompleteOrderTable from "../../../teamsTable/cloudCompleteOrderTable";
...
const normalizeFinanceRecord = (rec) => {
  ...
  return {
    ...
    cloudAction: rec.cloudAction || o.cloudAction,
    cloudActionTime: rec.cloudActionTime || rec.actionTime || o.cloudActionTime,
    cloudComments: rec.cloudComments || o.cloudComments,
    financeApprovedByUserId: approvedUserId,
    updatedBy: rec.updatedBy || o.updatedBy

  };
};

export default function CloudCompleteOrders() {
